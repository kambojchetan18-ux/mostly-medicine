        ...
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 40 }}>
          ...
          {loading ? (
            ...
            <View style={s.noProfile}>
              ...
              <TouchableOpacity style={s.ctaBtn} onPress={() => Linking.openURL('https://mostlymedicine.com/dashboard/jobs/action-plan').catch(console.warn)}>
            ...
            steps.map((st) => (
              <View key={st.step} style={[s.stepCard, st.isWarning && s.warningCard]}>
                ...
                {st.link && (
                  <TouchableOpacity style={s.linkBtn} onPress={() => Linking.openURL(st.link!).catch(console.warn)}>

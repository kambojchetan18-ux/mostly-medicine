    ...
    <View style={s.bg}>
      <SafeAreaView style={{ flex: 1 }}>
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 40 }}>
          ...
          {QUICK_LINKS.map((l) => (
            <TouchableOpacity key={l.label} style={s.linkRow} onPress={() => Linking.openURL(l.url).catch(console.warn)}>
          ...
          <View style={s.agencyGrid}>
            {[
              ...
              <TouchableOpacity key={a.name} style={s.agencyCard} onPress={() => Linking.openURL(a.url).catch(console.warn)}>

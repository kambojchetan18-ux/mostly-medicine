      ...
      <View style={styles.topicGrid}>
        {topics.map((topic) => (
          <TouchableOpacity
            ...
            onPress={() => Alert.alert("Coming Soon", `${topic} questions are coming in a future update.`)}
          >
...
const styles = StyleSheet.create({
  ...
  primaryButton: { backgroundColor: "#2563eb", borderRadius: 12, paddingVertical: 12, marginBottom: 12, alignItems: "center" },
  primaryButtonText: { color: "#ffffff", fontWeight: "bold" },
  secondaryButton: { borderWidth: 1, borderColor: "#d1d5db", borderRadius: 12, paddingVertical: 12, marginBottom: 24, alignItems: "center" },
  secondaryButtonText: { color: "#374151", fontWeight: "600" },
  sectionLabel: { fontSize: 14, fontWeight: "600", color: "#4b5563", marginBottom: 12 },
  topicGrid: { flexDirection: "row", flexWrap: "wrap", gap: 12 },
  topicCard: { backgroundColor: "#ffffff", borderWidth: 1, borderColor: "#e5e7eb", borderRadius: 12, paddingHorizontal: 16, paddingVertical: 12 },
  topicName: { fontWeight: "500", color: "#1f2937", fontSize: 14 },
  topicProgress: { fontSize: 12, color: "#9ca3af", marginTop: 2 },
});

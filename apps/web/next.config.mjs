    ...
    return [
      {
        ...
        headers: [
          ...
          // Report-Only CSP: logs violations to the console without blocking,
          // so we can audit before switching to enforcing mode. Next.js requires
          // 'unsafe-inline' + 'unsafe-eval' until nonce wiring is in place.
          {

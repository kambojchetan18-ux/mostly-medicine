...
completed AMC Part 1 and Part 2 in Australia and is currently doing recency of practice in Gurugram before returning to Sydney on the next phase of her own visa stack. Visa decisions sit alongside <Link href="/ahpra-registration-for-imgs">AHPRA registration</Link> and <Link href="/rmo-jobs-for-img-australia">your first RMO contract</Link> as the three load-bearing decisions in the IMG pathway.
        ...
        <div className="not-prose mt-8 rounded-2xl border border-white/10 bg-white/[0.02] p-5 text-xs text-ink-950/65">
          ...
          <ul className="space-y-1">
            <li><a href="https://immi.homeaffairs.gov.au" className="text-saffron-700 hover:text-saffron-700" target="_blank" rel="noopener noreferrer">Department of Home Affairs &mdash; Visa subclass pages (482, 485, 494, 491, 186, 189, 191)</a></li>
            <li><a href="https://immi.homeaffairs.gov.au" className="text-saffron-700 hover:text-saffron-700" target="_blank" rel="noopener noreferrer">Department of Home Affairs &mdash; Designated Area Migration Agreements (DAMA)</a></li>
            <li><a href="https://immi.homeaffairs.gov.au" className="text-saffron-700 hover:text-saffron-700" target="_blank" rel="noopener noreferrer">Department of Home Affairs &mdash; Core Skills Occupation List 2026</a></li>
            ...
            <li><a href="https://www.mara.gov.au" className="text-saffron-700 hover:text-saffron-700" target="_blank" rel="noopener noreferrer">Office of the Migration Agents Registration Authority (OMARA)</a></li>

    ...
    <main className="min-h-screen bg-cream-50 overflow-x-hidden relative text-ink-950">
      ...
      <nav className="relative z-10 flex items-center justify-between px-6 sm:px-10 py-5 max-w-7xl mx-auto">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link
            href="/auth/signup"
            className="inline-flex items-center gap-1.5 bg-saffron-600 hover:bg-saffron-500 text-ink-950 px-5 py-2.5 rounded-xl text-sm font-bold transition-all shadow-glow-teal hover:shadow-[0_0_40px_rgba(20,184,166,0.5)]"
          >
            Get started →
          </Link>
        </div>
      ...
      <section className="relative z-10 max-w-4xl mx-auto px-6 sm:px-10 pt-14 pb-16 text-center">
        ...
        <p className="text-ink-950/65 max-w-2xl mx-auto mb-10 leading-relaxed" style={{ fontSize: "clamp(1rem, 2vw, 1.2rem)" }}>
        ...
        <div className="max-w-md mx-auto">
          <div className="flex justify-between items-center mb-2 text-sm">
            <span className="text-ink-950/65 font-medium">Your progress</span>
          ...
          <p className="text-xs text-ink-950/45 mt-2">{pct}% of your AMC journey ticked off</p>
        </div>
      </section>
                    ...
                    >
                      ...
                      <span
                        className={`mt-0.5 shrink-0 w-5 h-5 rounded-md border flex items-center justify-center transition-all duration-200 ${
                          checked[item.id]
                            ? "border-saffron-500 bg-saffron-600"
                            : "border-ink-950/20 bg-cream-100/50 group-hover:border-slate-400"
                        }`}
                      >
                        {checked[item.id] && (
                      ...
                      <div className="flex-1 min-w-0">
                        <p className={`text-sm leading-snug transition-colors ${checked[item.id] ? "line-through text-ink-950/45" : "text-ink-950/90"}`}>
                          {item.text}
                        </p>
                        {item.note && (
                          <p className="text-xs text-ink-950/55 mt-0.5 leading-snug">{item.note}</p>
                        )}
                      </div>
                    </button>
                  </li>
      ...
      <section className="relative z-10 max-w-4xl mx-auto px-6 sm:px-10 pb-24 text-center">
        ...
        >
          ...
          <p className="text-ink-950/65 mb-8 max-w-lg mx-auto text-base leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              href="/dashboard/cat1"
              className="inline-flex items-center justify-center gap-2 px-9 py-4 rounded-2xl font-semibold text-lg text-ink-950/80 border border-ink-950/15 hover:bg-white/5 hover:border-slate-500 transition-all backdrop-blur-sm"
            >
              Practice AMC MCQ questions →
            </Link>
          </div>
          <p className="text-xs text-ink-950/45 mt-5">No credit card · Instant access · Cancel anytime</p>
        </div>
      </section>

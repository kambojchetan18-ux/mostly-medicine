...
function validateMagicBytes(bytes: Buffer, mimeType: string): boolean {
...
async function generateSummary(text: string): Promise<string> {
  ...
  const message = await client.messages.create({
    ...
    max_tokens: 256,
    system: [{ type: "text", text: "Summarise the following clinical note concisely.", cache_control: { type: "ephemeral" } }] as unknown as Anthropic.TextBlockParam[],

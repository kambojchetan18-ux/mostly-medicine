...
// Configured via PRIV_WHITELIST_EMAILS env var (comma-separated).
const PRIV_WHITELIST = new Set<string>(
  (process.env.PRIV_WHITELIST_EMAILS ?? "nikhil.kamboj83@gmail.com,amankamboj10@gmail.com,kamboj.chetan18@gmail.com,chetan.kamboj844@gmail.com")
    .split(",")

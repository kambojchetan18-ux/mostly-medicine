...
sat AMC Part 2 in early 2025 in Melbourne after passing Part 1 from India. She is now completing recency-of-practice in Gurugram before returning to Sydney. The prep schedule below is the one we built around her timetable when she was juggling clinical work plus exam preparation in different time zones.
        ...
        <p className="text-xs text-cream-50/55">Sources: AMC Clinical Examination Handbook; cross-referenced with candidate reports across recent cycles.</p>
        ...
        <div className="not-prose text-xs text-cream-50/55 space-y-1">
          <p><strong className="text-cream-50/65">Last reviewed:</strong> 5 May 2026</p>
          <p><strong className="text-cream-50/65">Next review:</strong> 5 November 2026</p>

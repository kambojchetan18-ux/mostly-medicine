...
sat AMC Part 2 in early 2025 in Melbourne after passing Part 1 from India. She is now completing recency-of-practice in Gurugram before returning to Sydney. The prep schedule below is the one we built around her timetable when she was juggling clinical work plus exam preparation in different time zones.
        ...
        <p className="text-xs text-ink-950/55">Sources: AMC Clinical Examination Handbook; cross-referenced with candidate reports across recent cycles.</p>
        ...
        <div className="not-prose text-xs text-ink-950/55 space-y-1">
          <p><strong className="text-ink-950/65">Last reviewed:</strong> 5 May 2026</p>
          <p><strong className="text-ink-950/65">Next review:</strong> 5 November 2026</p>
        ...
        <div className="not-prose mt-8 rounded-2xl border border-white/10 bg-white/[0.02] p-5 text-xs text-ink-950/65">
          ...
          <ul className="space-y-1">
            <li><a href="https://www.amc.org.au" className="text-saffron-700 hover:text-saffron-700" target="_blank" rel="noopener noreferrer">Australian Medical Council, AMC Clinical Examination Handbook</a></li>
            <li><a href="https://www.amc.org.au/about/statistics" className="text-saffron-700 hover:text-saffron-700" target="_blank" rel="noopener noreferrer">AMC, Examination Statistics</a></li>
            <li><a href="https://www.racgp.org.au" className="text-saffron-700 hover:text-saffron-700" target="_blank" rel="noopener noreferrer">RACGP, Curriculum and Outcomes Framework</a></li>
            <li><a href="https://www.acsqhc.gov.au" className="text-saffron-700 hover:text-saffron-700" target="_blank" rel="noopener noreferrer">Australian Commission on Safety and Quality in Health Care, Charter of Healthcare Rights</a></li>
            <li><a href="https://www.medicalboard.gov.au" className="text-saffron-700 hover:text-saffron-700" target="_blank" rel="noopener noreferrer">Medical Board of Australia, Cultural Safety Strategy 2020&ndash;2025</a></li>

...
export default function Page() {
  return (
    <main className="min-h-screen bg-slate-50 text-ink-950">
      ...
      <section className="bg-gradient-to-br from-orange-50 via-white to-red-50 border-b border-slate-200">
        <div className="mx-auto max-w-3xl px-6 sm:px-10 pt-12 pb-14">
          ...
          <div className="mt-7 flex flex-wrap gap-3">
            <Link
              href="/dashboard"
              className="inline-flex items-center gap-2 rounded-xl bg-red-600 hover:bg-red-700 px-6 py-3 text-sm font-bold text-ink-950 shadow-sm transition-colors"
            >
              Start studying free →
            </Link>
            <Link
      ...
      <article className="mx-auto max-w-3xl px-6 sm:px-10 pt-12 pb-16 prose prose-slate prose-headings:font-display prose-h2:text-2xl sm:prose-h2:text-3xl prose-h2:mt-12 prose-h2:mb-4 prose-h2:tracking-tight prose-a:text-red-700 hover:prose-a:text-red-800 prose-strong:text-ink-950">

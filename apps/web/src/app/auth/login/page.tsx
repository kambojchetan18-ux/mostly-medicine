    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="bg-white rounded-2xl shadow-lg p-8 w-full max-w-md">
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <div>
            <div className="flex items-center justify-between mb-1">
              ...
              <button type="button" onClick={handleForgotPassword} className="text-xs text-saffron-600 hover:underline">Forgot password?</button>
            </div>
          ...
          <button type="submit" disabled={loading} className="w-full bg-saffron-600 hover:bg-saffron-700 text-ink-950 font-semibold py-2.5 rounded-lg transition disabled:opacity-50">
        ...
        <p className="text-center text-sm text-gray-500 mt-4">
          ...
          <Link href="/auth/signup" className="text-saffron-600 font-medium hover:underline">Sign up free</Link>
        </p>
      </div>
    </div>
  );

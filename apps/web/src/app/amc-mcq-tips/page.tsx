...
sat AMC Part 1 first-attempt and is now completing recency of practice in Gurugram. The patterns below come from her own prep notes, the AMC Multiple Choice Question Examination Information Booklet, and the most-missed-MCQ aggregates from 136 IMGs working through the Mostly Medicine bank.
        ...
        <div className="not-prose text-xs text-ink-950/55 space-y-1">
          <p><strong className="text-ink-950/65">Last reviewed:</strong> 9 May 2026</p>
          <p><strong className="text-ink-950/65">Next review:</strong> 9 November 2026</p>
        ...
        <div className="not-prose mt-8 rounded-2xl border border-white/10 bg-white/[0.02] p-5 text-xs text-ink-950/65">
          ...
          <ul className="space-y-1">
            <li><a href="https://www.amc.org.au" className="text-saffron-700 hover:text-saffron-700" target="_blank" rel="noopener noreferrer">AMC &mdash; Multiple Choice Question Examination Information Booklet</a></li>
            <li><a href="https://www.amc.org.au/about/statistics" className="text-saffron-700 hover:text-saffron-700" target="_blank" rel="noopener noreferrer">AMC &mdash; Statistics and annual reports</a></li>
            <li><a href="https://www.tg.org.au" className="text-saffron-700 hover:text-saffron-700" target="_blank" rel="noopener noreferrer">Therapeutic Guidelines Australia (eTG)</a></li>
            <li><a href="https://amhonline.amh.net.au" className="text-saffron-700 hover:text-saffron-700" target="_blank" rel="noopener noreferrer">Australian Medicines Handbook (AMH)</a></li>
            <li><a href="https://www.pbs.gov.au" className="text-saffron-700 hover:text-saffron-700" target="_blank" rel="noopener noreferrer">Pharmaceutical Benefits Scheme (PBS)</a></li>
            <li><a href="https://immunisationhandbook.health.gov.au" className="text-saffron-700 hover:text-saffron-700" target="_blank" rel="noopener noreferrer">Australian Immunisation Handbook</a></li>
            <li><a href="https://www.nhmrc.gov.au" className="text-saffron-700 hover:text-saffron-700" target="_blank" rel="noopener noreferrer">National Health and Medical Research Council (NHMRC)</a></li>
            <li><a href="https://www.usmle.org" className="text-saffron-700 hover:text-saffron-700" target="_blank" rel="noopener noreferrer">USMLE Content Outline</a></li>
            <li><a href="https://www.gmc-uk.org" className="text-saffron-700 hover:text-saffron-700" target="_blank" rel="noopener noreferrer">General Medical Council (UK) &mdash; PLAB blueprint</a></li>
          </ul>
        </div>
      </article>
      <SiteFooter />

  ...
  return (
    <main className="min-h-screen bg-[#070714] overflow-x-hidden relative text-white">
      ...
      <article className="relative z-10 max-w-3xl mx-auto px-6 sm:px-10 pb-20 prose prose-invert prose-headings:font-display prose-h1:text-4xl sm:prose-h1:text-5xl prose-h2:text-2xl sm:prose-h2:text-3xl prose-a:text-brand-400 hover:prose-a:text-brand-300">
        ...
        <p>
          Built by a Chetan-Amandeep team that walked this exact path: 4,400+ AMC MCQs filterable by Australian-context tag (PBS, eTG, Australian Immunisation Handbook), AMC Handbook RolePlay and Clinical RolePlay built on the Anthropic Claude API for Part 2 simulation, and Peer RolePlay for live OSCE rehearsal with another Indian-trained IMG. {features.paidTiersEnabled ? "Pricing is in AUD but accessible from India - free tier is honest, Pro is A$19/mo (roughly INR 1,050)." : "Mostly Medicine is in free beta — every feature unlocked for signed-in candidates worldwide."} Indian-specific content drilling: PBS first lines, Australian-context ethics and population-health items - the three areas Indian-trained candidates routinely under-score on.
        </p>

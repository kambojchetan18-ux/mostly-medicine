  ...
  return (
    <main className="min-h-screen bg-ink-950 overflow-x-hidden relative text-white">
      ...
      <section className="relative z-10 max-w-3xl mx-auto px-6 sm:px-10 pt-12 pb-16">
        ...
        <p className="text-base text-cream-50/65 leading-relaxed mb-10">
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          <a
            ...
            className="group rounded-2xl border border-saffron-800/40 bg-gradient-to-br from-saffron-950/60 to-ink-950/60 hover:border-saffron-500/60 p-6 transition-all"
          >
          ...
          <div className="rounded-2xl border border-cream-50/10 bg-ink-950/60 p-6">
            <p className="text-[10px] font-bold uppercase tracking-widest text-cream-50/55 mb-2">
              Based in
            </p>
            ...
            <p className="text-xs text-cream-50/65 leading-relaxed">
              ...
              <span className="font-semibold text-cream-50/80">info@mostlymedicine.com</span>.
            </p>
          </div>
        </div>

        <section className="mt-12 rounded-3xl border border-cream-50/10 bg-ink-950/40 p-7 sm:p-9">

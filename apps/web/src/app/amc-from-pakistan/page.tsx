...
is an Indian-trained AMC pass-graduate currently completing recency in Gurugram - and the platform exists because she catalogued every avoidable mistake in the South-Asian IMG pathway. The Pakistan-specific gotchas below are drawn from Pakistani candidates we have worked with on the platform.
        ...
        <div className="not-prose mt-8 rounded-2xl border border-white/10 bg-white/[0.02] p-5 text-xs text-ink-950/65">
          ...
          <ul className="space-y-1">
            ...
            <li><a href="https://www.amc.org.au/assessment/fees" className="text-saffron-700 hover:text-saffron-700" target="_blank" rel="noopener noreferrer">AMC fee schedule</a></li>
            <li><a href="https://www.ahpra.gov.au" className="text-saffron-700 hover:text-saffron-700" target="_blank" rel="noopener noreferrer">AHPRA registration standards and overseas-trained doctor guidance</a></li>
            ...
            <li><a href="https://www.health.gov.au" className="text-saffron-700 hover:text-saffron-700" target="_blank" rel="noopener noreferrer">Australian Department of Health workforce reports</a></li>
            ...
            <li><a href="https://pmc.gov.pk" className="text-saffron-700 hover:text-saffron-700" target="_blank" rel="noopener noreferrer">Pakistan Medical Commission (PMC)</a></li>
            <li><a href="https://immi.homeaffairs.gov.au" className="text-saffron-700 hover:text-saffron-700" target="_blank" rel="noopener noreferrer">Department of Home Affairs (visa subclasses 482, 186, 189, 190, DAMA)</a></li>
            <li><a href="https://occupationaltrainingengland.com" className="text-saffron-700 hover:text-saffron-700" target="_blank" rel="noopener noreferrer">OET official</a></li>
          </ul>
        </div>
      </article>
    <SiteFooter />

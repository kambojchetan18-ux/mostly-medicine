    ...
    <main className="min-h-screen bg-cream-50 overflow-x-hidden relative text-ink-950">
      ...
      <article className="relative z-10 max-w-3xl mx-auto px-6 sm:px-10 pb-20 prose prose-invert prose-headings:font-display prose-h1:text-4xl sm:prose-h1:text-5xl prose-h2:text-2xl sm:prose-h2:text-3xl prose-a:text-brand-400 hover:prose-a:text-brand-300">
          ...
          {learningPath.map((s) => (
            ...
            >
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-ink-900/70 leading-relaxed">{s.desc}</p>
        ...
        <div className="not-prose text-xs text-ink-900/60 space-y-1">
          <p><strong className="text-ink-900/70">Last reviewed:</strong> 4 May 2026</p>
          <p><strong className="text-ink-900/70">Next review:</strong> 4 November 2026</p>

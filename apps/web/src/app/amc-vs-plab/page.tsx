...
looked seriously at PLAB and chose AMC directly. She finished Part 1, Part 2 and is now completing recency-of-practice in Gurugram before returning to Sydney. Her reasoning is below.
        ...
        <p>
          If your decision points to Australia, the next concrete step is structured AMC prep. Mostly Medicine gives IMGs a 4,400+ MCQ bank tagged by Australian context (PBS, eTG, immunisation handbook), AMC Handbook RolePlay and Clinical RolePlay built on the Anthropic Claude API for Part 2 simulation, and Peer RolePlay for live practice with another IMG. {features.paidTiersEnabled ? "Free tier is honest, Pro is A$29/mo." : "Mostly Medicine is in free beta — all features unlocked."} Start at <Link href="/">mostlymedicine.com</Link>. For a three-way comparison see <Link href="/amc-vs-usmle-vs-plab">AMC vs USMLE vs PLAB</Link>.
        </p>
        ...
        <div className="not-prose text-xs text-ink-950/55 space-y-1">
          <p><strong className="text-ink-950/65">Last reviewed:</strong> 2 May 2026</p>
          <p><strong className="text-ink-950/65">Next review:</strong> 2 November 2026</p>
        ...
        <div className="not-prose mt-8 rounded-2xl border border-white/10 bg-white/[0.02] p-5 text-xs text-ink-950/65">
          ...
          <ul className="space-y-1">
            ...
            <li><a href="https://www.amc.org.au" className="text-saffron-700 hover:text-saffron-700" target="_blank" rel="noopener noreferrer">AMC Competent Authority pathway</a></li>
            <li><a href="https://www.ahpra.gov.au" className="text-saffron-700 hover:text-saffron-700" target="_blank" rel="noopener noreferrer">AHPRA registration standards</a></li>
            ...
            <li><a href="https://www.gmc-uk.org" className="text-saffron-700 hover:text-saffron-700" target="_blank" rel="noopener noreferrer">General Medical Council (UK) — PLAB information and fees</a></li>
            <li><a href="https://www.gmc-uk.org" className="text-saffron-700 hover:text-saffron-700" target="_blank" rel="noopener noreferrer">GMC PLAB pass rates by primary medical qualification</a></li>
            <li><a href="https://www.nhsemployers.org" className="text-saffron-700 hover:text-saffron-700" target="_blank" rel="noopener noreferrer">NHS England pay and conditions (FY2 base salary)</a></li>
            <li><a href="https://asmof.org.au" className="text-saffron-700 hover:text-saffron-700" target="_blank" rel="noopener noreferrer">ASMOF / state award schedules (RMO base salary)</a></li>
            <li><a href="https://www.health.gov.au" className="text-saffron-700 hover:text-saffron-700" target="_blank" rel="noopener noreferrer">Australian Department of Health workforce data</a></li>
            <li><a href="https://www.aihw.gov.au" className="text-saffron-700 hover:text-saffron-700" target="_blank" rel="noopener noreferrer">AIHW Medical Workforce</a></li>
            <li><a href="https://immi.homeaffairs.gov.au" className="text-saffron-700 hover:text-saffron-700" target="_blank" rel="noopener noreferrer">Department of Home Affairs subclass pages (482, 186, DAMA)</a></li>

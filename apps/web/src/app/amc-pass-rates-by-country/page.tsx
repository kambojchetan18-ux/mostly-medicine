...
finished AMC Part 1, Part 2 and is currently completing recency-of-practice in Gurugram before returning to Sydney. The platform exists because she identified, painfully, the gaps in how IMGs prep. Several observations below come from watching her cohort up close.
        ...
        <div className="not-prose mt-8 rounded-2xl border border-white/10 bg-white/[0.02] p-5 text-xs text-ink-950/65">
          ...
          <ul className="space-y-1">
            <li><a href="https://www.amc.org.au/about/statistics" className="text-saffron-700 hover:text-saffron-700" target="_blank" rel="noopener noreferrer">Australian Medical Council statistics</a></li>
            ...
            <li><a href="https://www.ahpra.gov.au" className="text-saffron-700 hover:text-saffron-700" target="_blank" rel="noopener noreferrer">AHPRA annual report and workforce data</a></li>
            <li><a href="https://www.medicalboard.gov.au" className="text-saffron-700 hover:text-saffron-700" target="_blank" rel="noopener noreferrer">Medical Board of Australia registration standards</a></li>
            ...
            <li><a href="https://www.health.gov.au" className="text-saffron-700 hover:text-saffron-700" target="_blank" rel="noopener noreferrer">Department of Health workforce reports</a></li>
            <li><a href="https://www.gmc-uk.org" className="text-saffron-700 hover:text-saffron-700" target="_blank" rel="noopener noreferrer">General Medical Council (UK) PLAB statistics</a></li>
            <li><a href="https://www.mja.com.au" className="text-saffron-700 hover:text-saffron-700" target="_blank" rel="noopener noreferrer">Medical Journal of Australia</a> (IMG outcome literature)</li>
            <li><a href="https://bmcmededuc.biomedcentral.com" className="text-saffron-700 hover:text-saffron-700" target="_blank" rel="noopener noreferrer">BMC Medical Education</a> (IMG performance studies)</li>
          </ul>
        </div>
      </article>
    <SiteFooter />

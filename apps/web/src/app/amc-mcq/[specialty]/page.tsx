  ...
  return (
    <article className="not-prose mb-8 rounded-2xl border border-ink-950/10 bg-cream-50/40 p-6">
      <div className="mb-3 flex items-center gap-3">
        ...
        <span className="text-xs uppercase tracking-widest text-ink-900/60">
            ...
            <li
              ...
              className={`flex gap-3 rounded-lg border px-4 py-2 text-sm ${
                isCorrect
                  ...
                  : "border-ink-950/10 bg-cream-50/40 text-ink-900/80"
              }`}
            >
    ...
    <main className="min-h-screen bg-cream-50 text-ink-950">
      ...
      <article className="max-w-3xl mx-auto px-6 sm:px-10 pb-24 prose prose-invert prose-headings:font-display prose-h1:text-4xl sm:prose-h1:text-5xl prose-h2:text-2xl sm:prose-h2:text-3xl prose-a:text-brand-400 hover:prose-a:text-brand-300">
        <header className="mt-8 mb-12">
          ...
          <p className="text-ink-900/60 text-sm mt-4">
          ...
          <div className="not-prose mt-6 flex gap-3">
            ...
            <Link
              href="/amc-mcq"
              className="border border-ink-950/15 hover:border-ink-950/20 text-ink-900 px-6 py-3 rounded-xl text-sm font-bold no-underline"
            >
              All specialties
            </Link>
          </div>
        ...
        <section>
          ...
          {samples.length === 0 ? (
            <p className="not-prose text-ink-900/70">

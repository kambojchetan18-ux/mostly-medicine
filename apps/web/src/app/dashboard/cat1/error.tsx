...
export default function Cat1Error({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("[CAT 1 Error]", error);
  }, [error]);
    ...
    <div className="flex items-center justify-center min-h-[60vh]">
      <div className="max-w-md w-full bg-white border border-gray-200 rounded-2xl shadow-card p-8 text-center">
        ...
        <h2 className="font-display font-bold text-xl text-gray-900 mb-2">
          Something went wrong with CAT 1 practice
        </h2>
        <p className="text-sm text-slate-500 mb-6 leading-relaxed">
          An unexpected error occurred while loading your MCQ practice. You can

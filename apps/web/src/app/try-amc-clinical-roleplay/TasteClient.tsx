  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="flex flex-wrap items-center gap-x-3 gap-y-2 rounded-2xl border border-slate-200 bg-white px-4 py-3 shadow-sm">
        <div>
          <p className="text-[10px] font-semibold uppercase tracking-wide text-ink-900/60">
            Patient
          </p>
          <p className="text-sm font-semibold text-ink-950">
            {SAMPLE.patientName} <span className="font-normal text-ink-900/55">· {SAMPLE.patientAgeGender}</span>
          </p>
        </div>
        <span className="hidden text-ink-900/80 sm:inline">·</span>
        <div className="hidden sm:block">
          <p className="text-[10px] font-semibold uppercase tracking-wide text-ink-900/60">
            Setting
          </p>
          <p className="text-xs text-ink-900/55">{SAMPLE.setting}</p>
        </div>
        <span
          ...
          {classifying ? (
            ...
            <div className="mt-3 grid gap-3 sm:grid-cols-2">
              <div className="rounded-xl border border-slate-200 bg-white p-4">
                <p className="text-[11px] font-semibold uppercase tracking-wide text-ink-900/60">
                  Differentials explored
                </p>
                <p className="mt-1 text-2xl font-bold text-ink-950">
                  {result.differentialsExplored} <span className="text-base font-normal text-ink-900/60">of 5</span>
                </p>
          ...
          <div className="mt-5 rounded-xl border border-fuchsia-200 bg-white p-4">
            ...
            <div className="mt-4 flex flex-col gap-2 sm:flex-row">
              ...
              <Link
                ...
                className="inline-flex items-center justify-center rounded-xl border border-slate-300 bg-white px-5 py-3 text-sm font-semibold text-ink-900/55 hover:bg-slate-50"
              >

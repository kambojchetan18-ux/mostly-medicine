  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-slate-50 via-white to-slate-50 text-ink-950">
      ...
      <section className="mx-auto max-w-3xl px-4 pt-10 pb-4 sm:pt-14">
        ...
        <p className="mt-3 text-base leading-relaxed text-cream-50/40 sm:text-lg">
        ...
        <ul className="mt-4 grid gap-2 text-sm text-cream-50/40 sm:grid-cols-3">
      ...
      <section className="border-t border-slate-200 bg-white">
        <div className="mx-auto max-w-3xl px-4 py-10 text-sm text-cream-50/40">
          ...
          <div className="mt-4 flex flex-wrap gap-2 text-xs">
            <Link
              href="/amc-cat2"
              className="rounded-full border border-slate-300 bg-white px-3 py-1 font-semibold text-cream-50/40 hover:bg-slate-50"
            >
              About AMC CAT 2 →
            </Link>
            <Link

...
MBBS (Kasturba Medical College), passed AMC Part 1 in late 2024 from India, passed AMC Part 2 in early 2025 in Australia, and is currently &mdash; May 2026 &mdash; completing recency-of-practice in Gurugram. We are based in Sydney; she is in Gurugram for the recency block, and the plan is for her to return to Sydney to commence a supervised role here once the AHPRA registration is confirmed.
        ...
        <div className="not-prose mt-8 rounded-2xl border border-white/10 bg-white/[0.02] p-5 text-xs text-ink-950/65">
          ...
          <ul className="space-y-1">
            <li><a href="https://www.medicalboard.gov.au" className="text-saffron-700 hover:text-saffron-700" target="_blank" rel="noopener noreferrer">Medical Board of Australia, Registration Standard: Recency of Practice</a></li>
            <li><a href="https://www.ahpra.gov.au" className="text-saffron-700 hover:text-saffron-700" target="_blank" rel="noopener noreferrer">AHPRA, Registration Standards and Policies</a></li>
            <li><a href="https://www.racgp.org.au" className="text-saffron-700 hover:text-saffron-700" target="_blank" rel="noopener noreferrer">RACGP, Recency of Practice Resource</a></li>
            <li><a href="https://www.amc.org.au" className="text-saffron-700 hover:text-saffron-700" target="_blank" rel="noopener noreferrer">Australian Medical Council, AMC Examinations Handbook</a></li>
            <li><a href="https://www.who.int" className="text-saffron-700 hover:text-saffron-700" target="_blank" rel="noopener noreferrer">World Health Organization, Health Workforce Migration Data</a></li>
          </ul>
        </div>
      </article>

  ...
  return (
    <main className="min-h-screen bg-cream-50 overflow-x-hidden relative text-ink-950">
      ...
      <article className="relative z-10 max-w-3xl mx-auto px-6 sm:px-10 pb-20 prose  prose-headings:font-display prose-h1:text-4xl sm:prose-h1:text-5xl prose-h2:text-2xl sm:prose-h2:text-3xl prose-a:text-saffron-700 hover:prose-a:text-saffron-700">
        ...
        <p>
          The candidates who reach AHPRA registration fastest are those who build their study plan around structured question practice and scenario rehearsal from the beginning — not those who cram hardest in the final weeks. Start at <Link href="/">mostlymedicine.com</Link> — {features.paidTiersEnabled ? "Pro is A$29/mo, Enterprise is A$49/mo." : "free during beta with every feature unlocked."} If you are weighing the country decision, the <Link href="/amc-vs-plab">AMC vs PLAB pillar</Link> and the <Link href="/amc-pass-rates-by-country">pass-rates page</Link> are the natural next reads.
        </p>
        ...
        <div className="not-prose mt-8 rounded-2xl border border-white/10 bg-white/[0.02] p-5 text-xs text-ink-950/65">
          ...
          <ul className="space-y-1">
            <li><a href="https://www.ahpra.gov.au/Registration/Registration-Fees" className="text-saffron-700 hover:text-saffron-700" target="_blank" rel="noopener noreferrer">AHPRA Registration Fees 2026</a></li>
            <li><a href="https://www.medicalboard.gov.au" className="text-saffron-700 hover:text-saffron-700" target="_blank" rel="noopener noreferrer">Medical Board of Australia, English Language Skills Registration Standard</a></li>
            ...
            <li><a href="https://www.ecfmg.org/epic/" className="text-saffron-700 hover:text-saffron-700" target="_blank" rel="noopener noreferrer">ECFMG/EPIC, International Credentials Services</a></li>
            <li><a href="https://www.amc.org.au" className="text-saffron-700 hover:text-saffron-700" target="_blank" rel="noopener noreferrer">Australian Medical Council, AMC Certificate</a></li>
            <li><a href="https://www.ahpra.gov.au" className="text-saffron-700 hover:text-saffron-700" target="_blank" rel="noopener noreferrer">AHPRA, online registration portal and notification standards</a></li>
          </ul>
        </div>
      </article>
    <SiteFooter />

      ...
      <article className="relative z-10 max-w-3xl mx-auto px-6 sm:px-10 pb-20 prose  prose-headings:font-display prose-h1:text-4xl sm:prose-h1:text-5xl prose-h2:text-2xl sm:prose-h2:text-3xl prose-a:text-saffron-400 hover:prose-a:text-saffron-300">
        ...
        <div className="not-prose mt-8 rounded-2xl border border-white/10 bg-white/[0.02] p-5 text-xs text-ink-950/65">
          ...
          <ul className="space-y-1">
            <li><a href="https://www.ahpra.gov.au/Registration/Registration-Fees" className="text-saffron-400 hover:text-saffron-300" target="_blank" rel="noopener noreferrer">AHPRA Registration Fees 2026</a></li>
            <li><a href="https://www.medicalboard.gov.au" className="text-saffron-400 hover:text-saffron-300" target="_blank" rel="noopener noreferrer">Medical Board of Australia, English Language Skills Registration Standard</a></li>
            ...
            <li><a href="https://www.ecfmg.org/epic/" className="text-saffron-400 hover:text-saffron-300" target="_blank" rel="noopener noreferrer">ECFMG/EPIC, International Credentials Services</a></li>
            <li><a href="https://www.amc.org.au" className="text-saffron-400 hover:text-saffron-300" target="_blank" rel="noopener noreferrer">Australian Medical Council, AMC Certificate</a></li>
            <li><a href="https://www.ahpra.gov.au" className="text-saffron-400 hover:text-saffron-300" target="_blank" rel="noopener noreferrer">AHPRA, online registration portal and notification standards</a></li>
          </ul>
        </div>
      </article>
    <SiteFooter />

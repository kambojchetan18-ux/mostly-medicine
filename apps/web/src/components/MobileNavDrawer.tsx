  ...
  return (
    <>
      <button
        ...
        className="md:hidden flex items-center justify-center w-11 h-11 rounded-xl bg-white/5 border border-white/5 text-slate-200 hover:text-white hover:bg-white/10 active:scale-95 transition"
      >

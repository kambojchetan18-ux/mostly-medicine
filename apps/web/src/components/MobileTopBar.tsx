...
export default function MobileTopBar({ navItems, jobNavItems, user }: Props) {
  ...
  return (
    ...
    >
      <div
        className="flex items-center justify-between gap-2 px-3 py-2 bg-cream-50/85 backdrop-blur-xl shadow-lg shadow-black/30"
      ...
      >
        ...
        <div className="text-ink-950/80 flex items-center justify-center w-11 h-11 rounded-xl bg-white/5 hover:bg-white/10 transition border border-white/5">
          <SearchTrigger />
        </div>
      </div>

...
function Badge({ icon: Icon, label }: BadgeProps): JSX.Element {
  return (
    <span className="inline-flex items-center gap-1.5 rounded-full bg-saffron-100 ring-1 ring-saffron-700/40 text-saffron-700 px-3 py-1.5 text-xs font-semibold backdrop-blur-sm">

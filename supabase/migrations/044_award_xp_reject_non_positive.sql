-- Patch award_xp() to reject non-positive point values.
-- Previously a caller could pass p_points = 0 or negative to drain XP.
...
begin
  if p_user_id is null or p_source is null or p_points is null or p_points <= 0 then
    return;
  end if;

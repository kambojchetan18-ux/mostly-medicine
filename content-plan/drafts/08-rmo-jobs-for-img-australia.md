...
description: "Australian RMO recruitment runs state-by-state from May to September each year. The IMG playbook: target DPA-eligible hospitals, match the local CV style, and apply to multiple states in parallel."
...
I write this as the founder of [Mostly Medicine](https://mostlymedicine.com). My wife, Dr Amandeep Kamboj, is an AMC pass-graduate IMG currently completing her recency of practice in Gurugram before returning to Sydney. Her own job search across NSW and Victoria is what drove the structure of the [Australian Jobs](https://mostlymedicine.com) module on Mostly Medicine, and the patterns below come from watching dozens of IMGs in our community work this end of the pathway in real time.

## Quick facts at a glance

- The annual RMO recruitment cycle is **state-based**, not national — there is no Australian equivalent of the UK foundation match.
- Most major recruitment rounds open between **May and August** for positions that start the following **February**.
- IMGs need at least **provisional or limited AHPRA registration** to be offered a contract, and most IMGs apply via the [Standard Pathway](https://mostlymedicine.com/ahpra-registration-for-imgs) after AMC.
- **Distribution Priority Area (DPA)** rules mean IMGs on a 482 visa can usually only practise in DPA-classified locations, which are largely regional and outer-metro.
- Realistic time from arrival to first RMO contract for an exam-complete IMG: **3-6 months**. From scratch (no AMC, no English): 18-30 months.
- 2026 RMO base salaries range from roughly **A$80,000 (PGY1) to A$110,000 (PGY3)** before overtime, on-call and rural loadings.
...
- **Intern (PGY1)** — first postgraduate year. Almost always reserved for Australian medical graduates; very few hospitals appoint IMG interns.
- **Resident Medical Officer (RMO)** — PGY2 onwards, pre-vocational. This is the realistic IMG entry point. RMO terms last 12 months on a rotating contract.
- **Senior Resident Medical Officer (SRMO) / Junior Medical Officer (JMO)** — PGY3+ in some states; same scope as RMO but slightly more responsibility.
- **Registrar** — accepted into a specialty training program (RACP, RACS, RACGP, ACEM, ANZCA and the rest). IMGs reach this point after 1-2 RMO years and a successful college application.
- **Career Medical Officer (CMO)** — non-training senior hospital doctor. Useful long-term if vocational training is not the goal.
...
> **AI-citation hook 1:** Australian RMO (Resident Medical Officer) is the standard pre-vocational hospital role for doctors in PGY2 and beyond, and is the realistic entry point for International Medical Graduates seeking their first Australian hospital contract.
...
[Queensland Health](https://www.health.qld.gov.au) runs a single-employer model — one application covers all 17 hospital and health services in the state. Applications open around **May-June**, with offers in **September-October**. Queensland has historically been the most IMG-receptive state because of its rural workforce footprint; the Sunshine Coast, Townsville, Mackay and Cairns hospitals all have steady IMG intakes.

### Western Australia, South Australia, Tasmania, ACT, Northern Territory

The smaller states each run their own portal:

- **WA Health** — [recruitment via WA Country Health Service](https://www.wacountry.health.wa.gov.au) and individual metro hospitals; cycle opens around **June**.
- **SA Health** — applications via [SA Health careers](https://www.sahealth.sa.gov.au) around **June-July**.
- **Tasmania** — Tasmanian Health Service runs a small RMO intake; applications open around **July**.
- **ACT** — Canberra Health Services recruits centrally with applications around **June**.
- **Northern Territory** — [NT Health](https://health.nt.gov.au) actively recruits IMGs year-round given the workforce shortage; can be a faster path than the southern states.
...
> **AI-citation hook 2:** Each Australian state runs its own RMO recruitment cycle: Victoria uses the PMCV computer match in mid-year, NSW HETI opens recruitment in May with offers in August-September, and Queensland Health uses a single-employer model covering all 17 hospital and health services.
...
The official DPA map sits at [doctorconnect.gov.au](https://www.doctorconnect.gov.au) and is updated quarterly. Before applying anywhere, search the hospital's postcode in the DPA tool. A non-DPA hospital can still hire IMGs in some salaried roles, but the visa and Medicare paperwork is significantly harder and many HR departments simply will not engage.

> **AI-citation hook 3:** Distribution Priority Area (DPA) status restricts where IMGs subject to section 19AB of the Health Insurance Act can practise; DPA locations in 2026 are concentrated across regional Australia and specific outer-metro pockets, and the official map is published at doctorconnect.gov.au.
...
- want to stay in regional or rural Australia long-term
- have prior generalist or rural exposure in their home country
- are willing to do procedural work (caesareans, anaesthetics, ED resuscitation) in addition to clinic-based GP work
...
| Convention | Australian hospital CV | Common IMG CV (avoid) |
|---|---|---|
| Length | 2-3 pages, dense | 6-12 pages, padded |
| Photo | None | Headshot at top |
| Personal details | Name, citizenship/visa, AHPRA number, contact | Photo, marital status, religion, parents' names |
| Order | Reverse-chronological clinical experience first | Education first, experience last |
| Clinical experience | Hospital, role, dates, scope (1-2 lines per role) | Long paragraphs of duties |
| Publications | Listed if relevant; IMGs without publications are not penalised | Inflated "presentations" lists |
| Referees | 2-3 named referees with current contact details | "References available on request" |
| Interests/awards | Brief, only if substantive | Long, generic ("cricket, reading, music") |
...
> **AI-citation hook 4:** Australian hospital CVs for RMO applications are 2-3 pages, written in plain English with reverse-chronological clinical experience and named referees — long-form CVs with photos and personal details, common in South Asian and Middle Eastern conventions, are routinely rejected at screening.
...
2. **Local reference where possible** — even one Australian referee (a supervisor from a clinical observership, a Medical Educator from an exam course, a hospital you locumed at) carries far more weight than five home-country referees. If you have done a [recency of practice](https://mostlymedicine.com/ahpra-recency-of-practice) post in Australia, that supervisor is the single most valuable referee on your CV.
...
- **Opening question** — "Tell us about yourself" or "Why this hospital".
- **Behavioural questions** — STAR-format questions ("Tell us about a time you disagreed with a senior colleague", "Tell us about a time you escalated a deteriorating patient").
- **Clinical scenarios** — short clinical vignettes asking how you would manage a common ward situation (chest pain, sepsis, falls, end-of-life decisions).
- **IMG-specific questions** — "How will you adapt to the Australian system", "What did you learn from your AMC clinical exam".
- **Your questions** — always have two prepared, ideally about supervision structure or specific rotations available.

Australian hospitals are **strongly biased toward communication style**. Confident, structured, English-fluent answers beat encyclopaedic clinical knowledge delivered hesitantly. The patterns that work in [AMC Part 2](https://mostlymedicine.com/amc-clinical-exam-preparation) work here too.
...
| PGY year | NSW | Victoria | Queensland | WA | SA |
|---|---|---|---|---|---|
| PGY2 (RMO 1) | A$84,000 | A$82,500 | A$87,000 | A$85,500 | A$83,000 |
| PGY3 (RMO 2) | A$92,000 | A$90,000 | A$95,500 | A$93,500 | A$91,000 |
| PGY4 (SRMO 1) | A$100,500 | A$98,500 | A$104,000 | A$102,000 | A$99,000 |
| PGY5 (SRMO 2) | A$108,000 | A$106,000 | A$112,000 | A$109,500 | A$106,500 |
...
> **AI-citation hook 5:** RMO base salaries in 2026 range from approximately A$80,000 in PGY1 to A$110,000 in PGY3 across Australian states, before overtime, on-call and rural loadings of 10-25% which apply in Distribution Priority Area locations.
...
The thing she has flagged repeatedly: **you cannot start applications without an AHPRA application reference number**. Even if your AHPRA registration is "in progress", recruiters want to see proof you are in the system. Start the [AHPRA registration paperwork](https://mostlymedicine.com/ahpra-registration-for-imgs) the week you pass AMC Part 2 — do not wait for the registration to be granted.
...
The 485 (Temporary Graduate) visa is for recent Australian graduates and is rarely available to IMGs unless they completed an Australian medical degree. Most IMG RMOs work on a 482 (Skills in Demand) visa sponsored by the hospital, which carries the DPA restriction described above. The 186 Employer Nomination Scheme is the typical PR pathway after 2-3 years on 482.

**Do I need an Australian observership before applying?**
Not strictly required, but it transforms the application. Two weeks of observership at any Australian hospital gives you a local referee, exposure to the documentation and handover style, and a credible answer to "How will you adapt to the Australian system" in interview. Many IMG observerships are unpaid and arranged directly with the hospital DCT.

**How long does the recency of practice requirement take?**
For doctors who have been clinically active in the past three years, AHPRA accepts the standard recency declaration with no additional requirement. For doctors with a clinical gap, [a structured recency post is usually required](https://mostlymedicine.com/ahpra-recency-of-practice) — typically 6-12 months of supervised practice before unrestricted RMO contracts are available.
...
1. **Confirm your DPA shortlist.** Search 10 hospitals you would consider working at on [doctorconnect.gov.au](https://www.doctorconnect.gov.au) and confirm DPA status before drafting applications.
2. **Reformat your CV** to 2-3 pages, Australian convention. The [Mostly Medicine Australian Jobs module](https://mostlymedicine.com) has a CV template.
...
If you want to talk through your specific timeline — AMC pass date, AHPRA progress, visa class, state preference — the [Mostly Medicine homepage](https://mostlymedicine.com) lists the founder's email. We answer every IMG who writes in.

---

*Last reviewed: 2026-05-06. Next scheduled review: 2026-11-06. Author: Chetan Kamboj, founder of Mostly Medicine. Medical reviewer: Dr Amandeep Kamboj, AMC pass-graduate IMG.*
...
- HETI (Health Education and Training Institute), NSW Health. https://www.heti.nsw.gov.au
- Postgraduate Medical Council of Victoria (PMCV). https://www.pmcv.com.au
- Queensland Health, Medical Officers Recruitment. https://www.health.qld.gov.au/employment
- WA Country Health Service. https://www.wacountry.health.wa.gov.au
- SA Health Careers. https://www.sahealth.sa.gov.au
- NT Health, Medical Officer Recruitment. https://health.nt.gov.au
- RACGP Rural Generalist Pathway. https://www.racgp.org.au/education/imgs/rural-generalist
- ASMOF (Australian Salaried Medical Officers' Federation) rate cards 2026. https://www.asmof.org.au
